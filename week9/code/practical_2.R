...
# read in data
tapir_IUCN <- st_read('../data/data_0.shp')
print(tapir_IUCN)
...
ne110 <- st_read('../data/ne_110m_admin_0_countries.shp')
...
bioclim_future <- cmip6_world(var='bioc', res=10, ssp="585", model='HadGEM3-GC31-LL', time="2041-2060", path='data')
...
tapir_IUCN <- st_set_crs(tapir_IUCN, 4326)
